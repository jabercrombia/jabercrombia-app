      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="flex items-center gap-6">
            <Link href="https://github.com/jabercrombia" target="_blank" rel="noopener noreferrer" className="footer-link inline-flex items-center gap-1.5">
            ...
            <Link href="https://www.linkedin.com/in/justinabercrombia" target="_blank" rel="noopener noreferrer" className="footer-link inline-flex items-center gap-1.5">
