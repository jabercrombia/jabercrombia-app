      ...
      <div className="container mx-auto px-6">
        ...
        <section className={styles.hero}>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-[12px] tracking-[0.05em] text-[var(--primary-color)] hover:text-foreground transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-16">
          {certifications.map((cert) => (
            <div key={cert.title} className="bg-muted border border-[var(--border-subtle)] px-4 py-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-color)] shrink-0" />
                <span className="text-[12.5px] text-foreground font-medium">{cert.title}</span>
              </div>
              <div className="text-[10px] tracking-[0.1em] uppercase text-muted-foreground pl-3.5">{cert.org}</div>
            </div>
          ))}
        </div>
